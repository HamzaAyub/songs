...
public class AdapterVideoByCategory extends ArrayAdapter<ItemModelVideoByCategory> {
    ...
    public AdapterVideoByCategory(Activity act, int resource, List<ItemModelVideoByCategory> arrayList, int columnWidth) {
