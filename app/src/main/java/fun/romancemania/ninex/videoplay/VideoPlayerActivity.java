package fun.romancemania.ninex.videoplay;
 ...
 * <p/>
 * <pre>
 *      Intent lVideoIntent = new Intent(null, Uri.parse("ytpl://"+YOUTUBE_PLAYLIST_ID), this, VideoPlayerActivity.class);
...
public class VideoPlayerActivity extends Activity {
    ...
    private void setupView() {
        ...
        RelativeLayout.LayoutParams lRelLayoutParms = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        lRelLayout.setLayoutParams(lRelLayoutParms);
        lLinLayout.addView(lRelLayout);

        mVideoView = new VideoView(this);
        mVideoView.setId('3');
        RelativeLayout.LayoutParams lVidViewLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        RelativeLayout.LayoutParams lProgressBarLayoutParms = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        RelativeLayout.LayoutParams lProgressMsgLayoutParms = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private class QueryYouTubeTask extends AsyncTask<YouTubeId, ProgressUpdateInfo, Uri> {
        ...
        protected Uri doInBackground(YouTubeId... pParams) {
            if (pParams[0] instanceof FIleId) {
                ...
                try {
                    ...
                    TelephonyManager lTelephonyManager = (TelephonyManager) VideoPlayerActivity.this.getSystemService(Context.TELEPHONY_SERVICE);
        ...
        protected void onPostExecute(Uri pResult) {
            ...
            try {
                ...
                final MediaController lMediaController = new MediaController(VideoPlayerActivity.this);
        ...
        private void showErrorAlert() {
            ...
            try {
                Builder lBuilder = new Builder(VideoPlayerActivity.this);
        ...
        protected void onProgressUpdate(ProgressUpdateInfo... pValues) {
            ...
            VideoPlayerActivity.this.updateProgress(pValues[0].mMsg);
        }
